...
import { ExpandableSection, PremiumTabs } from "@/components/ui/progressive-disclosure";
                ...
                <div className="min-w-0 space-y-6">
                  <PremiumPanel className="p-5">
                    ...
                    <div className="space-y-4">
                      ...
                      <ExpandableSection title="Supported formats" description="CSV, Excel, PDF, and text files up to 50MB.">
          ...
          },
          {
            ...
            content: (
              <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
                <PremiumPanel className="p-5 xl:col-span-2">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm leading-6 text-muted-foreground">
                        The result step confirms whether the local validation state is ready for analyst review.
                      </p>
                    </div>
                    <Badge variant={analysisState === "ready" ? "secondary" : "outline"} className="w-fit">
                      {analysisState === "ready" ? "Ready" : "Not run"}
                    </Badge>
                  </div>
                  <div className="mt-5 grid gap-4 sm:grid-cols-3">
                    <MetricDeltaCard
                      ...
                      detail={`${selectedSample.rows} mock periods`}
                      tone={selectedSample.status === "Valid" ? "good" : "watch"}
                    />
                    <MetricDeltaCard
                      label="Manual company"
                      value={manualInput.ticker}
                      detail={manualInput.companyName}
                      tone="info"
                    />
                    <MetricDeltaCard
                      label="Validation"
                      value={analysisState === "ready" ? "Ready" : "Pending"}
                      detail="Local UI state only"
                      tone={analysisState === "ready" ? "good" : "watch"}
                    />
                  </div>
                  <div className="mt-5 rounded-lg border bg-muted/30 p-4 text-sm leading-6 text-muted-foreground">
                    No file contents are persisted, parsed into real records, or sent to providers. This step only previews the intended completion state.
                  </div>
                </PremiumPanel>
                ...
                <div className="space-y-6">
                  ...
                  <ExpandableSection title="Recent uploads" description="Static examples for the mocked intake history.">
                  ...
                  <ExpandableSection title="Data processing" description="Future backend workflow, not active in this prototype.">
